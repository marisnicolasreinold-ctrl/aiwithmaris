...
(function () {
  ...
  var STR = {
    de: {
      ...
      privacy: 'Deine Nachrichten werden zur Beantwortung an einen KI-Dienst (Anthropic) übermittelt und nicht dauerhaft gespeichert. Keine persönlichen Daten eingeben. Details: ',
    ...
    en: {
      ...
      privacy: 'Your messages are sent to an AI service (Anthropic) to generate answers and are not stored permanently. Please do not enter personal data. Details: ',
